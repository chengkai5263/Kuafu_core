...
class XGBoost(BaseModel):
    ...
    def __init__(self, params={'n_estimators': 20, 'learning_rate': 0.025},
        ...
        """
        # 初始化父类
        super(XGBoost, self).__init__(predict_type=predict_type, irradiance=irradiance,
        ...
        # XGBoost模型
        self.__model_xgb_withoutp = XGBRegressor(**params)
        self.__model_xgb_withp = XGBRegressor(**params)
    ...
    def fit(self, feature_data, target_data, *args, **kwargs):
        ...
        :return:
        """
        self.__model_xgb_withoutp.fit(feature_data, target_data)
        self.__model_xgb_withp.fit(numpy.hstack((feature_data[1:, :], target_data[:-1].reshape(1, -1).T)),
    ...
    def predict_without_history_power(self, feature, *args, **kwargs):
        ...
        :return:
        """
        result = self.__model_xgb_withoutp.predict(feature)
    ...
    def predict_with_history_power(self, feature, history_power, *args, **kwargs):
        ...
        for i in range(len(feature)):
            result[i] = self.__model_xgb_withp.predict(numpy.hstack((feature[i, :], history_power)).reshape(1, -1))
